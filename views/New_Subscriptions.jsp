	...
	<div align="right" style="margin-top: 5%;">
		...
		<div class="btn-group btn-group-justified" style="width: 85%;">
			<button class="btn btn-primary btn-lg" type="button"
				...
				aria-expanded="false" aria-controls="#subCollapse">الاشتراكات المتاحه</button>
			&nbsp;
			<button class="btn btn-primary btn-lg" type="button"
				data-toggle="collapse" data-target="#newSubCollapse"
				aria-expanded="false" aria-controls="#newSubCollapse">تسجيل
				اشتراك جديد</button>
		...
		<div align="right" id="accordionExample2" style="margin-top: 1%;">
			...
			<div class="btn-group">
				<div id="newSubCollapse" class="collapse"
										...
										<tr>
											<td>
												<button type="button" class="btn btn-warning btn-xs"
													...
													data-cui="${aCust.cid}" data-cna="${aCust.name}">اشتراك
													جديد</button>
											</td>
					...
					<form:form class="addNewSub" action="NewSubscriptions"
						method="post">
							...
							<div class="modal-dialog modal-dialog-scrollable" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">تسجيل
											اشتراك جديد</h5>
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<input class="form-control" name="price" type="text"
												id="price" value="" readonly="readonly" />
										</div>
									</div>
